  ...
  return (
    <>
      ...
      <Section title="9. Contact">
        <p>If you have any questions about these terms, please contact us at support@qrew.dev.</p>
      </Section>
    </>
  )
}
  ...
  return (
    <>
      ...
      <Section title="9. Contacto">
        <p>Si tienes alguna pregunta sobre estos términos, contáctanos en support@qrew.dev.</p>
      </Section>
    </>
  )
}
