...
import termsHtml from '@/features/legal/terms.html?raw'
                ...
                <div className="flex items-start gap-2">
                  <FormControl>
                    <input
                      id="terms_accepted"
                      type="checkbox"
                      // the visible wording is split so the link falls outside the label,
                      // so the control carries the whole sentence as its accessible name
                      aria-label={t('auth.acceptTermsLabel')}
                  ...
                  <p className="leading-snug">
                    <FormLabel htmlFor="terms_accepted" className="cursor-pointer font-normal">
                      {t('auth.acceptTerms')}
                    </FormLabel>{' '}
                    {/* the link sits outside the label, since inside it every click on
                        the wording would also toggle the acceptance */}
                    <button
                      type="button"
                      className="text-primary underline"
                      onClick={() => setTermsOpen(true)}
                    >
                      {t('profile.about.terms')}
                    </button>
                  </p>
                </div>
                <FormMessage />
