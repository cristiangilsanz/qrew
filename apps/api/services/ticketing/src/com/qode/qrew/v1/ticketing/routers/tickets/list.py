...
@router.get(
    ...
    summary="List the tickets owned by the authenticated user, minus long past events",
)
...
async def list_tickets(
    ...
    del request
    tickets = await TicketRepository(db).list_by_user(current_user.id, now=datetime.now(UTC))
