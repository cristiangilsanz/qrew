...
from com.qode.qrew.v1.payments.core.database import AsyncSessionLocal
...
# drains the outbox when a transaction notifies it, and every minute as a safety net
@job("payments.outbox.drain", cron=parse_crontab("* * * * *"), max_attempts=1)
