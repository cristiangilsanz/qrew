# defines the audit action enum and the audit event table
import enum
import uuid
...
from com.qode.qrew.v1.audit.core.database import Base
...
class AuditEvent(Base):
    ...
    device_fingerprint_hash: Mapped[str | None] = mapped_column(String(255), nullable=True)
