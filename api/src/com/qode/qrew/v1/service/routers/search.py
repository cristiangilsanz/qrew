...
from com.qode.qrew.v1.service.core.api import Page, clamp_limit
...
from com.qode.qrew.v1.service.schemas.search.events import EventSearchResult
...
async def _events_table_exists(db: AsyncSession) -> bool:
    """Return whether the events table is already in the database."""
...
async def search_events(
    ...
    """Search published events by text and filters."""
    del request
