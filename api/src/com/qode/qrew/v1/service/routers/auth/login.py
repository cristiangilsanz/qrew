...
from com.qode.qrew.v1.service.services.auth.login_lockout import LoginLockoutError
from com.qode.qrew.v1.service.services.auth.logout import LogoutError, LogoutService
from com.qode.qrew.v1.service.services.auth.refresh import (
    RefreshError,
    RefreshService,
...
async def login(
    ...
    try:
        ...
        raise domain_error(
            exc.message, exc.field, status.HTTP_401_UNAUTHORIZED
        ) from exc
