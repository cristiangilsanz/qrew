...
from com.qode.qrew.v1.service.core.storage.keys import ObjectKey, is_valid_key
from com.qode.qrew.v1.service.core.storage.signing import SignedUrl, sign, verify
...
class LocalFilesystemBackend:
    ...
    def sign_put_url(
        self, key: ObjectKey, content_type: str, ttl_seconds: int
    ) -> SignedUrl:
        ...
        return SignedUrl(
            url=url, key=key, expires_at=expires_at, content_type=content_type
        )
    ...
    async def verify_signed_get(
        self, key: ObjectKey, expires_at: int, signature: str
    ) -> None:
        verify(
            secret=self._signing_secret,
            method="GET",
