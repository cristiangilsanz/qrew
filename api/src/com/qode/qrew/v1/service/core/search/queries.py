...
from com.qode.qrew.v1.service.core.api.page import decode_cursor, encode_cursor
from com.qode.qrew.v1.service.core.search.config import SearchConfig
from com.qode.qrew.v1.service.core.search.tsvector import normalise_query


@dataclass(frozen=True)
class SearchClause:
    """SQL fragments produced from a search request."""
...
def build_search_clause(
    *,
    ...
    """Compose the SQL pieces a search route needs to execute its query."""
    parameters: dict[str, object] = {}
    where: list[str] = []
...
def encode_next_cursor(last_rank: float, last_id: str) -> str:
    """Encode the cursor that follows the row with this rank and id."""
