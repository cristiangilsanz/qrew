...
def _generate_keypair() -> tuple[str, str]:
    """Generate a fresh PEM-encoded scanner key pair."""
...
def scanner_public_key() -> str:
    """Return the scanner public key used for offline verification."""
    return _PUBLIC_KEY
...
def create_scanner_token(
    ...
    """Mint a short-lived scanner token scoped to a venue and event."""
