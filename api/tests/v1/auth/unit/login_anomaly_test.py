...
from com.qode.qrew.v1.service.services.geoip import GeoIpService, haversine_km
from com.qode.qrew.v1.service.services.login_anomaly import LoginAnomalyService

_GEOIP_MODULE = "com.qode.qrew.v1.service.services.geoip.geoip2.database.Reader"
...
# ── LoginAnomalyService — no anomaly ─────────────────────────────────────────
...
# ── LoginAnomalyService — impossible travel ───────────────────────────────────
...
async def test_check_detects_impossible_travel() -> None:
    ...
    with patch(
        "com.qode.qrew.v1.service.services.login_anomaly.settings"
    ) as mock_settings:
...
async def test_check_does_not_flag_slow_travel() -> None:
    geoip = MagicMock(spec=GeoIpService)
    geoip.locate.return_value = (40.4, -3.7)
    geoip.distance_km.return_value = 50.0  # 50 km in 2 hours → 25 km/h
...
# ── LoginAnomalyService — concurrent device ───────────────────────────────────
