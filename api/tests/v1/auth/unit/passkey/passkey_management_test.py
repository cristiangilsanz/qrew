...
from com.qode.qrew.v1.service.routers.auth import get_passkey_management_service
...
def override_dependencies(mock_service: AsyncMock) -> Iterator[None]:
    app.dependency_overrides[get_passkey_management_service] = lambda: mock_service
    yield
