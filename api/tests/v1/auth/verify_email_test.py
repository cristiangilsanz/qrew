...
from com.qode.qrew.v1.service.routers.auth import _get_email_verification_service
...
def override_service(mock_service: AsyncMock) -> Iterator[None]:
    app.dependency_overrides[_get_email_verification_service] = lambda: mock_service
    yield
