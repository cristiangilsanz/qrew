"""In-process WebSocket subscriber index. No Redis — NATS is the message bus."""
...
from com.qode.qrew.v1.hub.core.close_codes import WS_CLOSE_INTERNAL, WS_CLOSE_OVERLOAD
