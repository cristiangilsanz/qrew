...
from com.qode.qrew.v1.catalog.repositories.search.config import SearchConfig
from com.qode.qrew.v1.catalog.repositories.search.tsvector import normalise_query
