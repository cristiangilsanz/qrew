...
from com.qode.qrew.v1.identity.core.ws.auth import (
    WebSocketAuthError,
    authenticate,
)
...
from com.qode.qrew.v1.identity.core.ws.hub import Hub
from com.qode.qrew.v1.identity.core.ws.registry import resolve
...
async def channel_socket(
    ...
    try:
        allowed = await definition.can_subscribe(identity.user, params, identity.session)
    except Exception as exc:
