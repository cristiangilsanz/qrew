...
from com.qode.qrew.v1.identity.services.ratelimit.lua_script import LUA_SCRIPT
...
class RateLimiter:
    ...
    def __init__(
        ...
        *,
        ...
        self._fail_open = _settings.ratelimit_fail_open if fail_open is None else fail_open
