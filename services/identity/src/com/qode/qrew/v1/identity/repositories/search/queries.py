...
from com.qode.qrew.v1.identity.repositories.search.config import SearchConfig
from com.qode.qrew.v1.identity.repositories.search.tsvector import normalise_query
