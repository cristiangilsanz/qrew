...
from com.qode.qrew.v1.identity.core.storage.encryption import (
    decrypt as _decrypt,
)
from com.qode.qrew.v1.identity.core.storage.encryption import (
    encrypt as _encrypt,
...
def constraint_for(kind: str) -> UploadConstraint:
    """Return the upload limits configured for the given kind."""
...
class StorageService:
    """High-level facade callers use to put, get, and sign storage objects."""
