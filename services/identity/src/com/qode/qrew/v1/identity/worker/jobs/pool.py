...
def redis_settings_from_url(url: str | None = None) -> RedisSettings:
    """Builds Redis connection settings from a URL, defaulting to the configured connection string."""
...
async def get_pool() -> ArqRedis:
    """Returns the shared Redis connection pool, initializing it on first access."""
