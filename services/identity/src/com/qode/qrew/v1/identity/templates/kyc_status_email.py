def kyc_status_email(full_name: str, status: str, reason: str | None) -> str:
    ...
    heading = "Your identity has been verified!" if approved else "KYC verification unsuccessful"
    intro = (
    ...
    reason_block = f"<p><strong>Reason:</strong> {reason}</p>" if reason and not approved else ""
    next_steps = (
