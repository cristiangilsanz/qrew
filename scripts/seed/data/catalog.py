...
EVENTS = (
    Event(
        key="event-a",
        name="Event A",
        description="Published. Tests the ordinary purchase while the sale is open.",
        status="published",
        organisation="org-a",
        venue="venue-a",
    ...
    Event(
        key="event-b",
        name="Event B",
        description="Published. Tests the wait before a sale opens.",
        status="published",
        organisation="org-a",
        venue="venue-b",
    ...
    Event(
        key="event-c",
        name="Event C",
        description="Ongoing. Tests validation at the gate while the event runs.",
        status="ongoing",
        organisation="org-a",
        venue="venue-c",
        starts_in_hours=-1,
    ...
    Event(
        key="event-d",
        name="Event D",
        description="Draft. Tests that an unpublished event stays hidden.",
        status="draft",
        organisation="org-a",
        venue="venue-a",
    ...
    Event(
        key="event-e",
        name="Event E",
        description="Cancelled. Tests what a published event leaves once called off.",
        status="cancelled",
        organisation="org-a",
        venue="venue-b",
    ...
    Event(
        key="event-f",
        name="Event F",
        description="Published. Tests the waiting room that governs admission.",
        status="published",
        organisation="org-a",
        venue="venue-a",
    ...
    Event(
        key="event-g",
        name="Event G",
        description="Ongoing. Tests an event whose end has already passed.",
        status="ongoing",
        organisation="org-b",
        venue="venue-c",
        starts_in_hours=-30,
    ...
    Event(
        key="event-h",
        name="Event H",
        description="Published. Tests the resale market once the sale has closed.",
        status="published",
        organisation="org-a",
        venue="venue-b",
    ...
    Event(
        key="event-m",
        name="Event M",
        description="Published. Tests issuing a code straight after buying.",
        status="published",
        organisation="org-a",
        venue="venue-a",
        starts_in_hours=2,
